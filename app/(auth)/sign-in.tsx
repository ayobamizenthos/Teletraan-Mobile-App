import { View, StyleSheet, Pressable, TextInput, Text, Platform } from 'react-native'
...
export default function SignInScreen() {
  ...
  const handleSignIn = () => {
    ...
    if (result.deployment === 'unconnected') {
  ...
  return (
    <View style={styles.container}>
      ...
      {errorState === 'password' && (
        <Text style={styles.errorText}>
          Your account isn&apos;t currently connected to a Teletraan site or device.
        </Text>
      )}
