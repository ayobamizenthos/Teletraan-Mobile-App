  ...
  return (
    <View style={[StyleSheet.absoluteFill, setupStyles.wrapper]}>
      ...
      <View style={[StyleSheet.absoluteFill, setupStyles.backdropBlur]} pointerEvents="none">
        {Platform.OS !== 'web' && (
          // Subtle backdrop. iOS uses its real native blur. Android falls
          // back to a flat dark tint (no real blur) — intentional, to avoid
          // the dimezisBlurView edge-line artifact and full-screen issues.
