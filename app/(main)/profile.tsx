...
const DEFAULT_AVATAR = require('../../assets/images/Zenthos.png')
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        >
          ...
          <GradientStrokeBox width={40} height={36} rx={5} strokeWidth={0.48} />
        </Pressable>
      </View>
      ...
      >
        <Pressable style={styles.avatarContainer} onPress={pickAvatar}>
          <View style={styles.avatarBox}>
            <Image
              ...
              contentFit="cover"
            />
            <GradientStrokeBox width={100} height={87} rx={10} strokeWidth={0.33} />
          </View>
        </Pressable>
        ...
        >
          ...
          <GradientStrokeBox width={98} height={25} rx={5} strokeWidth={0.8} />
        </Pressable>
            ...
            <Animated.View style={animatedAccordionStyle}>
              <View style={styles.accordionFields}>
                <View style={styles.infoRow}>
                  ...
                  <Text style={styles.infoValue}>Ayobami Zenthos</Text>
                </View>
                <View style={styles.infoRow}>
                  <Text style={styles.infoLabel}>Email</Text>
                  <Text style={styles.infoValue}>zenthos@avzdax.com</Text>
                </View>
                <View style={styles.infoRow}>
