...
function HeaderPanicIcon() {
  return (
    <Svg width={40} height={36} viewBox="0 0 40 36" fill="none" pointerEvents="none">
      <Defs>
        <LinearGradient
          id="scv_hdr_cam"
          x1={-5.294}
            ...
            <View style={styles.viewSwitcherOuter}>
              <View style={styles.viewSwitcherInner}>
                ...
                >
                  ...
                  {!filterActive && <GradientStrokeBox width={81} height={29} rx={5} />}
                </Pressable>
              </View>
              <GradientStrokeBox width={281} height={48} rx={10} />
            </View>
