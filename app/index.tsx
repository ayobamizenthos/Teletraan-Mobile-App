...
// AppFrame renders the whole app inside a fixed 375×812 canvas (scaled to
// fill on native, letterboxed on web). Position the splash against that
// canvas, not useWindowDimensions — the browser viewport is often 1440+ wide
// and would push the logo entirely off the 375-wide frame.
const DESIGN_W = 375
const LOGO_W = 78
const LOGO_H = 90
// Y anchor traced from the Figma splash: the mark sits at ~35% down the
// canvas, not vertical-centered, so the "TELETRAAN" wordmark below reads at
// the design's mid-line rather than getting pushed toward the footer.
const LOGO_TOP = 227
