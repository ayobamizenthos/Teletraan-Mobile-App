...
export default function AppFrame({ children }: AppFrameProps) {
  ...
  // Anchor to the top of the screen instead of vertically centring. Taller
  // Android aspects (20:9, 21:9) leave leftover space when we scale-to-fit;
  // centring puts that as a visible strip under the status bar. Pushing it
  // all to the bottom hides it behind the home-indicator / nav-bar area.
  const offsetY = 0
