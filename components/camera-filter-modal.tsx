...
export default function CameraFilterModal({
  ...
  return (
    <View style={styles.backdrop}>
      ...
      {/* Android: solid dark tint — dimezisBlurView caused a white cast at
          screen edges on some OEM builds. A uniform tint reads identical
          across every device. Backdrop bg already carries the darker Android
          value, so nothing extra needed here. */}
        ...
        {chips.map(chip => {
          ...
          return (
            ...
            >
              ...
              {!isSelected && <GradientStrokeBox width={chip.w} height={37} rx={5} />}
            </Pressable>
          )
        })}
...
const styles = StyleSheet.create({
  backdrop: {
    ...
    alignItems: 'center',
    zIndex: 1000,
    backgroundColor: Platform.OS === 'android' ? 'rgba(0,0,0,0.55)' : 'rgba(0,0,0,0.35)',
    overflow: 'hidden',
  },
  backdropWebBlur: {
