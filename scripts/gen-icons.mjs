...
// Splash icon uses fill=1 (no padding) so imageWidth in app.json controls the
// on-screen size exactly. With padding, expo-splash-screen scales the visible
// mark to less than the requested width and it looks cropped on small OEMs.
await renderForeground(512, 1, join(assets, 'splash-icon.png'))
