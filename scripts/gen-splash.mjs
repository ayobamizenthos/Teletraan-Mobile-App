...
// Native splash — a static PNG of the JS splash (app/index.tsx) rendered at
// 1242×2688 so it stays sharp on high-DPI Android devices. Rendered via SVG
// so we can position glow layers at their design-native negative offsets.
const SCALE = 3.3125
const DESIGN_W = 375
const DESIGN_H = 812
